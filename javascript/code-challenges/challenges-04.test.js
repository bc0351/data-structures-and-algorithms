...
const sortPeople = (arr) => {
  return arr.sort((p1, p2) => { return (p1.lastName < p2.lastName) ? -1 : 1});
};
...
const sortPeopleBetter = (arr) => {
  return arr.sort((p1, p2)  => { return (p1.lastName === p2.lastName) ? ((p1.firstName === p2.firstName) ? ((p1.age === p2.age) ? 0 : (p1.age < p2.age) ? -1 : 1) : (p1.firstName < p2.firstName) ? -1 : 1) : ((p1.lastName < p2.lastName) ? -1 : 1)});
};
...
const sortMeetingsByDay = (arr) => {
  return arr.sort((mtg1, mtg2) => {return days.indexOf(mtg1.dayOfWeek) - days.indexOf(mtg2.dayOfWeek)});
};
...
const sortSchedule = (arr) => {
  return arr.sort((mtg1, mtg2) => {
    let mtg1DayNum = days.indexOf(mtg1.dayOfWeek),
        mtg2DayNum = days.indexOf(mtg2.dayOfWeek),
        mtg1Start = parseInt(mtg1.start),
        mtg2Start = parseInt(mtg2.start),
        mtg1Dur = parseInt(mtg1.end) - parseInt(mtg1.start),
        mtg2Dur = parseInt(mtg2.end) - parseInt(mtg2.start);
    return (mtg1DayNum === mtg2DayNum) ? ((mtg1Start === mtg2Start) ? ((mtg1Dur=== mtg2Dur) ? 0 : (mtg1Dur < mtg2Dur) ? -1 : 1) : (mtg1Start < mtg2Start) ? -1 : 1) : ((mtg1DayNum < mtg2DayNum) ? -1 : 1)
  });
};

...
const houseSize = (arr) => {
  const sizes = [];
  arr.map(o => sizes.push({'house': o.house, 'members': o.members}));
  return sizes;
};
...
const houseSurvivors = (arr) => {
  const survivors = [];
  let numMembers = 0;
  arr.map((o => {return {house: o.name}, {members: Object.values(o).length}}).filter(o => survivors.push(typeof Object.values(o) === 'array' ? o.children.length : numMembers = numMembers + 1)))
  return survivors;
  };
